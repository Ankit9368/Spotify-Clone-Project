...
async function getSongs(folder) {
    ...
    for (const song of songs) {
        ...
        <div class="playnow">
            <span>Play Now</span>
            <img width="26px" class="invert" src="img/play.png" alt="">
        </div>
    </li>`
    }
...
async function main() {
    ...
    document.querySelector(".seekbar").addEventListener("click", e => {
        let clientpart = (e.offsetX / e.target.getBoundingClientRect().width) * 100
        document.querySelector(".circle").style.left = clientpart + "%"
        currentSong.currentTime = ((currentSong.duration) * clientpart) / 100
    })
